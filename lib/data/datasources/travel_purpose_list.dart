class MetaTravelPurposeListResponse {
  bool? status;
  String? token;
  String? message;
  List<Data>? data;

  MetaTravelPurposeListResponse({this.status, this.token, this.message, this.data});

  MetaTravelPurposeListResponse.fromJson(Map<String, dynamic> json) {
