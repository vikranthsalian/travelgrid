class MetaFareClassListResponse {
  bool? status;
  String? token;
  String? message;
  List<Data>? data;

  MetaFareClassListResponse({this.status, this.token, this.message, this.data});

  MetaFareClassListResponse.fromJson(Map<String, dynamic> json) {
