  class MetaCurrencyListResponse {
  bool? status;
  String? token;
  String? message;
  List<Data>? data;

  MetaCurrencyListResponse({this.status, this.token, this.message, this.data});

  MetaCurrencyListResponse.fromJson(Map<String, dynamic> json) {
