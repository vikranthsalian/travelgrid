class MetaMiscTypeListResponse {
  bool? status;
  String? token;
  String? message;
  List<Data>? data;

  MetaMiscTypeListResponse({this.status, this.token, this.message, this.data});

  MetaMiscTypeListResponse.fromJson(Map<String, dynamic> json) {
